...
import com.priorDev.pokerroutejc.featurePokemon.data.network.response.AbilityResponse
import com.priorDev.pokerroutejc.featurePokemon.data.network.response.PokemonResponse
import com.priorDev.pokerroutejc.featurePokemon.data.network.response.SpritesResponse
import com.priorDev.pokerroutejc.featurePokemon.data.network.response.StatResponse
