...
import com.prior_dev.pokerroutejc.feature_pokemon.presentation.components.PokemonBasicInfo
import com.prior_dev.pokerroutejc.feature_pokemon.presentation.components.Sprites
import com.prior_dev.pokerroutejc.feature_pokemon.presentation.components.Weaknesses
...
fun PokemonDetailsView(
    ...
    Column(
        ...
        weaknessesAndStrengths?.let {
            Weaknesses(Modifier.padding(cardPadding), it)
        }
